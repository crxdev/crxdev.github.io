...
var i_34653 = (0);
while(true){
if((i_34653 < arr.length)){
(arr[i_34653] = null);

var G__34654 = (i_34653 + (1));
i_34653 = G__34654;
continue;
} else {
}
...
var i_34679 = (self__.level + (1));
while(true){
if((i_34679 <= (new_level + (1)))){
(update[i_34679] = self__.header);

var G__34682 = (i_34679 + (1));
i_34679 = G__34682;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_34683 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_34683[i]));
} else {
x__$2.forward.push((((i < links_34683.length))?(links_34683[i]):null));
}

if((i < links_34683.length)){
(links_34683[i] = x__$2);
} else {
links_34683.push(x__$2);
}
...
var i_34688 = (0);
while(true){
if((i_34688 <= self__.level)){
var links_34690 = (update[i_34688]).forward;
if((x__$1 === (((i_34688 < links_34690.length))?(links_34690[i_34688]):null))){
(links_34690[i_34688] = (x__$1.forward[i_34688]));

var G__34693 = (i_34688 + (1));
i_34688 = G__34693;
continue;
} else {
var G__34694 = (i_34688 + (1));
i_34688 = G__34694;
continue;
}
} else {
...
var G__34703 = nx;
var G__34704 = (level__$1 - (1));
x = G__34703;
level__$1 = G__34704;
continue;
} else {
var G__34706 = x;
var G__34707 = (level__$1 - (1));
x = G__34706;
level__$1 = G__34707;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__34716 = nx;
var G__34717 = (level__$1 - (1));
x = G__34716;
level__$1 = G__34717;
continue;
} else {
var G__34718 = x;
var G__34719 = (level__$1 - (1));
x = G__34718;
level__$1 = G__34719;
continue;
}
