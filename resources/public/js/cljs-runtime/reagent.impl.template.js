...
var G__42746 = o;
reagent.impl.template.goog$module$goog$object.set(G__42746,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__43013__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__43013 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__43014__i = 0, G__43014__a = new Array(arguments.length -  0);
while (G__43014__i < G__43014__a.length) {G__43014__a[G__43014__i] = arguments[G__43014__i + 0]; ++G__43014__i;}
  args = new cljs.core.IndexedSeq(G__43014__a,0,null);
} 
return G__43013__delegate.call(this,args);};
G__43013.cljs$lang$maxFixedArity = 0;
G__43013.cljs$lang$applyTo = (function (arglist__43015){
var args = cljs.core.seq(arglist__43015);
return G__43013__delegate(args);
});
...
var G__42774 = o;
reagent.impl.template.goog$module$goog$object.set(G__42774,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__43020__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__43020 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__43021__i = 0, G__43021__a = new Array(arguments.length -  0);
while (G__43021__i < G__43021__a.length) {G__43021__a[G__43021__i] = arguments[G__43021__i + 0]; ++G__43021__i;}
  args = new cljs.core.IndexedSeq(G__43021__a,0,null);
} 
return G__43020__delegate.call(this,args);};
G__43020.cljs$lang$maxFixedArity = 0;
G__43020.cljs$lang$applyTo = (function (arglist__43022){
var args = cljs.core.seq(arglist__43022);
return G__43020__delegate(args);
});
G__43020.cljs$core$IFn$_invoke$arity$variadic = G__43020__delegate;
return G__43020;
})()
;
} else {
...
var G__42805 = props;
var G__42805__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__42805,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__42805);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__42805__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__42825 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__42825,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__42825;
}
})(),id_class);
...
var G__42837 = (cljs.core.count(argv) - first_child);
switch (G__42837) {
case (0):
...
var vec__42846 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42846,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42846,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42846,(2),null);
...
var temp__5757__auto___43037 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___43037 == null)){
} else {
var key_43038 = temp__5757__auto___43037;
(jsprops.key = key_43038);
}
...
var temp__5757__auto___43040 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___43040 == null)){
} else {
var key_43041 = temp__5757__auto___43040;
(jsprops.key = key_43041);
}
...
var temp__5757__auto___43042 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___43042 == null)){
} else {
var key_43043 = temp__5757__auto___43042;
(jsprops.key = key_43043);
}
...
var temp__5757__auto___43061 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___43061 == null)){
} else {
var key_43063 = temp__5757__auto___43061;
(jsprops.key = key_43063);
}
...
var temp__5757__auto___43071 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___43071 == null)){
} else {
var key_43072 = temp__5757__auto___43071;
(jsprops.key = key_43072);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42885_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__42885_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__42940 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42940,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42940,(1),null);
...
break;
default:
var G__43082 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__43083 = compiler;
v = G__43082;
compiler = G__43083;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template42974 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template42974 = (function (opts,id,fn_to_element,parse_fn,meta42975){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template42974.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_42976,meta42975__$1){
var self__ = this;
var _42976__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template42974(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta42975__$1));
}));

(reagent.impl.template.t_reagent$impl$template42974.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_42976){
var self__ = this;
var _42976__$1 = this;
return self__.meta42975;
}));

(reagent.impl.template.t_reagent$impl$template42974.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template42974.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template42974.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template42974.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template42974.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template42974.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta42975","meta42975",1134621572,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template42974.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template42974.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template42974");

(reagent.impl.template.t_reagent$impl$template42974.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template42974");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template42974.
 */
reagent.impl.template.__GT_t_reagent$impl$template42974 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template42974(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta42975){
return (new reagent.impl.template.t_reagent$impl$template42974(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta42975));
});

}

return (new reagent.impl.template.t_reagent$impl$template42974(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
